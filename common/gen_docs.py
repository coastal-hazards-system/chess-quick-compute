...
def gen_user_manual(apps):
    lines = ["# CHESS-QC — User Manual",
             ...
             "- **(III) provisional** — a needed coefficient or relationship had to be guessed or "
...
def gen_outdated(apps):
    ...
    lines = ["# CHESS-QC — Outdated / Superseded Applications",
             "*Coastal Hazards, Engineering, and Structures System (CHESS) — Quick Compute (QC)*",
             "",
             "These tools remain available (often valuable for screening, teaching, or "
             "consistency with legacy studies) but a newer method is preferred for routine "
             "design. See the Technical Reference for the full Status & Caveats. "
