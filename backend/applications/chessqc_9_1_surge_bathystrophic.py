...
INPUTS = (
    ...
    Field("Vf", "Forward speed", "float", "m/s", "kt", default=22.0 * _KT,
    ...
    Field("Vmax", "Max wind (optional)", "float", "m/s", "mph", default=0.0,
...
OUTPUTS = (
    ...
    Out("Vmax_out", "Max wind speed (30 ft)", "m/s", "mph", "scalar"),
