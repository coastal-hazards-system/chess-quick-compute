...
| 9-1 | Bathystrophic Storm Surge | II | Screening only | analytic / literature |
| 10-1 | Water Level Detrending | II | Current | see notes |
| 10-2 | Non-Tidal Residual | II | Current | see notes |
| 10-3 | Peaks Over Threshold | II | Current | see notes |
| 10-4 | Probabilistic Simulation Technique | II | Current | see notes |
...
- **Source / references:** ACES TR 1-1 eqs. 5-19; Silva (2005) eqs. 7.16-7.19; Lumley & Panofsky (1964)
- **Module:** `backend/applications/chessqc_1_5_near_surface_wind.py`
- **Regression test:** `test_1_5_near_surface_wind`: PASS (neutral log law, exact revised PBL branches, stability sign)

Validated by the regression test above: neutral log law, exact revised PBL branches, stability sign.
...
### 3-2 — Irregular Wave Transformation (Goda's Method)  (II — standard)
...
### 9-1 — Bathystrophic Storm Surge  (II — standard)
...
Validation: Bodine TM-35 Chesapeake Bay Entrance example (Pc=27.57, Pn=29.92 inHg, R=35 nm, Vf=22 kt, lat 37 deg, K=0.0025) -> reported peak 13.41 ft at 17 h. The source- curve path is checked against that published result (within the precision of its rounded curve ordinates); the parametric paths are checked separately by their analytic wind/pressure identities. self-contained, numpy + stdlib only.
...
### 10-2 — Non-Tidal Residual  (II — standard)

- **Source / references:** NOAA CO-OPS tide/residual practice; PyStorm NTR
- **Module:** `backend/applications/chessqc_10_2_non_tidal_residual.py`

_Validation note in the app docstring / build notes._

### 10-3 — Peaks Over Threshold  (II — standard)

- **Source / references:** Coles (2001); USACE coastal-hazards practice; PyStorm POT
- **Module:** `backend/applications/chessqc_10_3_peaks_over_threshold.py`

_Validation note in the app docstring / build notes._

### 10-4 — Probabilistic Simulation Technique  (II — standard)

- **Source / references:** Coles (2001); Nadal-Caraballo et al. PST; PyStorm PST
